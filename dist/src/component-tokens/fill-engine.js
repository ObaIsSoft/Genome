 ...
 */
function buildGradient(vec, baseHex, accentHex, sem) {
 ...
 */
export function computeFill(vec, sem, baseHex, accentHex, primaryHex) {
    ...
    if (sem.containsMedia && sem.isTextPrimary)
        objectPosition = 'center top';
    if (sem.visualWeight > 0.8 && sem.containsMedia)
 ...
 */
export function gradientTextCSS(fill) {
    if (!fill.textGradient)
        return null;
    return {
